...
export const navigationService = {
  getAllScreens() {
    return [
      ...
      { id: 'creator-earnings', name: 'Creator Earnings', path: '/creator-earnings-command-center-with-stripe-integration', category: 'Creator Tools', roles: ['creator', 'admin'], icon: 'DollarSign', keywords: ['earnings', 'revenue', 'payouts'] },
      ...
      { id: 'brand-dashboard', name: 'Brand Dashboard', path: '/brand-dashboard-specialized-kp-is-center', category: 'Advertising', roles: ['advertiser', 'admin'], icon: 'Target', keywords: ['brand', 'kpis', 'metrics'] },
      ...
      { id: 'bulletin-board', name: 'Public Bulletin Board', path: '/public-bulletin-board-audit-trail-center', category: 'Compliance', roles: ['admin'], icon: 'FileText', keywords: ['bulletin', 'board', 'audit'] },
