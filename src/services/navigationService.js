import {
  ...
  AUTOMATED_PAYMENT_PROCESSING_HUB_ROUTE,
  STRIPE_PAYMENT_INTEGRATION_HUB_ROUTE,
  STRIPE_LOTTERY_PAYMENT_INTEGRATION_CENTER_ROUTE,
  STRIPE_SUBSCRIPTION_MANAGEMENT_CENTER_ROUTE,
  USER_SUBSCRIPTION_DASHBOARD_ROUTE,
  MULTI_CURRENCY_SETTLEMENT_DASHBOARD_ROUTE,
  FINANCIAL_TRACKING_ZONE_ANALYTICS_CENTER_ROUTE,
  ENHANCED_ADMIN_REVENUE_ANALYTICS_HUB_ROUTE,
  REGIONAL_REVENUE_ANALYTICS_DASHBOARD_ROUTE,
  REVENUE_FRAUD_DETECTION_ANOMALY_PREVENTION_CENTER_ROUTE,
  INTERNATIONAL_PAYMENT_DISPUTE_RESOLUTION_CENTER_ROUTE,
  LOCALIZATION_TAX_REPORTING_INTELLIGENCE_CENTER_ROUTE,
  ENHANCED_DYNAMIC_REVENUE_SHARING_CONFIGURATION_CENTER_ROUTE,
  COST_ANALYTICS_ROI_DASHBOARD_ROUTE,
  ANTHROPIC_CLAUDE_REVENUE_RISK_INTELLIGENCE_CENTER_ROUTE,
...
export const navigationService = {
  ...
  getAllScreens() {
    return [
      ...
      // Payments & Finance
      { id: 'payment-processing', name: 'Payment Processing', path: AUTOMATED_PAYMENT_PROCESSING_HUB_ROUTE, category: 'Finance', roles: ['admin'], icon: 'CreditCard', keywords: ['payments', 'processing', 'transactions'] },
      { id: 'stripe-integration', name: 'Stripe Integration', path: STRIPE_PAYMENT_INTEGRATION_HUB_ROUTE, category: 'Finance', roles: ['admin'], icon: 'CreditCard', keywords: ['stripe', 'payments', 'integration'] },
      { id: 'stripe-gamified', name: 'Stripe Gamified', path: STRIPE_LOTTERY_PAYMENT_INTEGRATION_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'Gift', keywords: ['gamified', 'stripe', 'prizes'] },
      { id: 'stripe-subscription', name: 'Stripe Subscriptions', path: STRIPE_SUBSCRIPTION_MANAGEMENT_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'CreditCard', keywords: ['subscriptions', 'stripe', 'billing'] },
      { id: 'user-subscription', name: 'User Subscriptions', path: USER_SUBSCRIPTION_DASHBOARD_ROUTE, category: 'Finance', roles: ['voter', 'creator', 'advertiser', 'admin'], icon: 'CreditCard', keywords: ['subscription', 'plan', 'billing'] },
      { id: 'multi-currency', name: 'Multi-Currency Settlement', path: MULTI_CURRENCY_SETTLEMENT_DASHBOARD_ROUTE, category: 'Finance', roles: ['admin'], icon: 'DollarSign', keywords: ['currency', 'settlement', 'international'] },
      { id: 'financial-tracking', name: 'Financial Tracking', path: FINANCIAL_TRACKING_ZONE_ANALYTICS_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'DollarSign', keywords: ['financial', 'tracking', 'analytics'] },
      { id: 'revenue-analytics', name: 'Revenue Analytics', path: ENHANCED_ADMIN_REVENUE_ANALYTICS_HUB_ROUTE, category: 'Finance', roles: ['admin'], icon: 'TrendingUp', keywords: ['revenue', 'analytics', 'earnings'] },
      { id: 'regional-revenue', name: 'Regional Analytics', path: REGIONAL_REVENUE_ANALYTICS_DASHBOARD_ROUTE, category: 'Finance', roles: ['admin'], icon: 'Map', keywords: ['regional', 'revenue', 'analytics', 'geography'] },
      { id: 'revenue-fraud', name: 'Revenue Fraud Detection', path: REVENUE_FRAUD_DETECTION_ANOMALY_PREVENTION_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'ShieldAlert', keywords: ['fraud', 'detection', 'revenue', 'anomaly'] },
      { id: 'payment-disputes', name: 'Dispute Resolution', path: INTERNATIONAL_PAYMENT_DISPUTE_RESOLUTION_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'Scale', keywords: ['dispute', 'resolution', 'payment', 'international'] },
      { id: 'tax-reporting', name: 'Tax & Localization', path: LOCALIZATION_TAX_REPORTING_INTELLIGENCE_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'FileText', keywords: ['tax', 'reporting', 'localization', 'compliance'] },
      { id: 'revenue-sharing', name: 'Revenue Sharing Config', path: ENHANCED_DYNAMIC_REVENUE_SHARING_CONFIGURATION_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'Settings', keywords: ['revenue', 'sharing', 'config', 'dynamic'] },
      { id: 'cost-analytics-roi', name: 'Cost Analytics & ROI', path: COST_ANALYTICS_ROI_DASHBOARD_ROUTE, category: 'Finance', roles: ['admin'], icon: 'DollarSign', keywords: ['cost', 'analytics', 'roi', 'redis', 'datadog', 'supabase', 'caching'] },
      { id: 'claude-revenue', name: 'Claude Revenue Intelligence', path: ANTHROPIC_CLAUDE_REVENUE_RISK_INTELLIGENCE_CENTER_ROUTE, category: 'Finance', roles: ['admin'], icon: 'Brain', keywords: ['revenue', 'risk', 'intelligence'] },
