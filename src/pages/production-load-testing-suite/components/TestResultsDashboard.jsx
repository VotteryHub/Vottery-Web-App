...
const MOCK_RESULTS = [
  { scale: '10K', responseTime: 45, errorRate: 0.1, throughput: 9800, status: 'passed' },
  { scale: '100K', responseTime: 78, errorRate: 0.3, throughput: 95000, status: 'passed' },
  { scale: '500K', responseTime: 145, errorRate: 0.8, throughput: 470000, status: 'passed' },
  { scale: '1M', responseTime: 210, errorRate: 1.2, throughput: 920000, status: 'passed' },
  { scale: '10M', responseTime: 380, errorRate: 2.1, throughput: 8500000, status: 'passed' },
  { scale: '50M', responseTime: 620, errorRate: 3.5, throughput: 42000000, status: 'warning' },
  { scale: '100M', responseTime: 950, errorRate: 5.2, throughput: 82000000, status: 'warning' },
  { scale: '500M', responseTime: 1800, errorRate: 8.7, throughput: 380000000, status: 'failed' },
  { scale: '1B', responseTime: 3200, errorRate: 15.3, throughput: 720000000, status: 'failed' },
];
...
const TestResultsDashboard = () => {
  ...
  const warnings = MOCK_RESULTS?.filter(r => r?.status === 'warning')?.length;
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Comprehensive pass/fail analysis with historical trends</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-gray-300 px-3 py-1.5 rounded-lg text-sm transition-colors">
