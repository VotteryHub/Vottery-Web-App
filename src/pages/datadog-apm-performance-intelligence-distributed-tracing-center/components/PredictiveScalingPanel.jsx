    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Automated infrastructure adjustments based on traffic patterns, performance thresholds, and capacity planning algorithms
        </p>
      </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-semibold text-primary">{alert?.confidence}% Confidence</span>
                  </div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">{alert?.endpoint}</h4>
