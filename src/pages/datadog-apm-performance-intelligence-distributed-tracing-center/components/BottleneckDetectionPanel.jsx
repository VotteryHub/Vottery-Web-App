    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-3xl font-bold text-gray-900 dark:text-gray-100">{bottlenecks?.length || 0}</span>
          </div>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
          ...
          Automated Bottleneck Detection with Machine Learning
        </h3>
          ...
          bottlenecks?.map((bottleneck, index) => (
            ...
            >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                      {bottleneck?.requestCount} requests analyzed
                    </span>
                  </div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">{bottleneck?.endpoint}</h4>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                ...
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="text-xs text-gray-600 dark:text-gray-400">P95 Response Time</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-gray-100">{bottleneck?.p95ResponseTime}ms</div>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  {bottleneck?.recommendations?.map((rec, idx) => (
                    <div key={idx} className="p-3 bg-white dark:bg-gray-800 rounded-lg">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-semibold text-gray-900 dark:text-gray-100 uppercase">{rec?.type}</span>
                        <span
