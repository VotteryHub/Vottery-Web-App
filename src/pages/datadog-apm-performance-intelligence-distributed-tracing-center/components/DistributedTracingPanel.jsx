...
const DistributedTracingPanel = ({ slowTransactions }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          End-to-end transaction flows with service dependency mapping, latency breakdown analysis, and error propagation tracking
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
          ...
          Slow Transactions (>3s Response Time)
        </h3>
        <div className="space-y-3">
          {slowTransactions?.length === 0 ? (
            <div className="text-center py-8">
              <Icon name="CheckCircle" size={48} className="mx-auto text-green-500 mb-4" />
              <p className="text-gray-600 dark:text-gray-400">No slow transactions detected</p>
            </div>
          ) : (
            slowTransactions?.map((transaction, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`text-sm font-semibold ${getStatusColor(transaction?.statusCode)}`}>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-gray-100">{traceDetails?.totalDuration}ms</div>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="text-xs text-gray-600 dark:text-gray-400">Span Count</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-gray-100">{traceDetails?.spanCount}</div>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="text-xs text-gray-600 dark:text-gray-400">Errors</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-gray-100">{traceDetails?.errorCount}</div>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Span Timeline:</h4>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{ width: `${(span?.responseTime / traceDetails?.totalDuration) * 100}%` }}
                        />
                        <span className="text-xs text-gray-600 dark:text-gray-400">{span?.responseTime}ms</span>
                      </div>
                    </div>
                  </div>
                ))}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Supabase PostgreSQL</span>
          </div>
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <Icon name="Server" size={16} className="text-blue-500" />
            <span className="text-sm text-gray-700 dark:text-gray-300">API Gateway</span>
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">Stripe API</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
            <span className="text-sm text-gray-700 dark:text-gray-300">Database connection timeouts</span>
          ...
          <div className="flex items-center justify-between p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
            <span className="text-sm text-gray-700 dark:text-gray-300">External API rate limits</span>
