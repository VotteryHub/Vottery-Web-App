  ...
  return (
    <GeneralPageLayout title="Creator Success Academy" showSidebar={true}>
      <div className="w-full py-0">
        ...
        {/* Learning Modules */}
        <div className="bg-card backdrop-blur-md rounded-3xl border border-border p-8 mb-8 shadow-2xl">
          <h2 className="text-xl font-black text-foreground uppercase tracking-tight mb-6">Learning Modules</h2>
          ...
          <div className="space-y-4">
            {filteredModules.map(m => (
              <div key={m.id} className="flex gap-5 p-5 rounded-2xl border border-border bg-muted/30 hover:bg-muted/50 transition-all group">
                ...
                <div>
                  <h3 className="font-black text-foreground uppercase tracking-tight">{m.title}</h3>
        ...
        <div className="bg-card backdrop-blur-md rounded-3xl border border-border p-8 mb-8 shadow-2xl">
          <h2 className="text-xl font-black text-foreground uppercase tracking-tight mb-3">Achievement Milestones</h2>
          <p className="text-sm text-muted-foreground font-medium mb-6">
            Track your progress; unlock badges and insights as you hit these goals.
          </p>
          <div className="space-y-3">
            {MILESTONES.map((m, i) => (
              <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-muted/30 border border-border hover:bg-muted/50 transition-all group">
