...
const EventSchedulingPanel = ({ groupId, isModerator }) => {
  ...
  const getMockEvents = () => [
    ...
    { id: '3', title: 'Creator Networking Meetup', description: 'Connect with fellow election creators in your area', event_date: new Date(Date.now() + 14 * 86400000)?.toISOString()?.split('T')?.[0], event_time: '18:00', event_type: 'in-person', location: 'Community Center, NYC', attendees: 12, max_attendees: 30, rsvp_enabled: true },
  ];
