-- =====================================================
-- Run this in Supabase Dashboard > SQL Editor if you
-- cannot use the CLI ("supabase db push" or "npm run db:push").
-- Same as: migrations/20260228100000_ensure_user_wallets_and_backfill_from_wallets.sql
-- =====================================================
