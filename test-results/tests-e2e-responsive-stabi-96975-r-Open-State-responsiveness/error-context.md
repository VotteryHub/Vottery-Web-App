...
- Name: tests\e2e\responsive-stability.spec.js >> Responsive Stability & Visual Regression >> Viewport: Tablet-Portrait (768x1024) >> Verify Drawer Open State responsiveness
